...
node .\build\ff-ranwithemcp\ffmpeg.js -loglevel verbose -encoders



node .\test1.mjs -loglevel verbose -encoders
...
@REM node .\build\ff-ranwithemcp\ffmpeg.js -loglevel verbose -f lavfi -i "testsrc2=duration=5.1:size=352x288,realtime" -f matroska -c:v h263 -flush_packets 1 file:///J:/Dev/alqwertyuiopasdfghjkl1cEj1.webm
